    ...
    <div className="box login">
      <h1 style={{ marginLeft: "10px" }}>
        <AccountCircleOutlinedIcon
          style={{ fontSize: "34px", marginRight: "13px", color: "#DBDBDB" }}
        />
        Авторизация
      </h1>

      <div className="box-body">
        <Form submitForm={props.login} values={state}>
          <Field>
            <Input label="E-mail" name="username" />
          </Field>
          ...
          <Field>
            <Select label="Аккаунт" name="account_id" empty={false}>
              {props.isDictsLoaded &&
