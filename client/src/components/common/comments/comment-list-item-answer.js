...
class CommentListItemAnswer extends React.Component {
  ...
  render() {
    const answers = this.props.parentGroups[this.props.data.id] || [];
      ...
      <React.Fragment>
        <div className="comments__item">
          ...
          <div className="comments__item-date">
            <time>
              {moment(this.props.data.date_created).format(
                "DD MMM YYYY в hh:mm",
              )}
            </time>
          </div>
          <div className="comments__item-title">{this.props.data.msg}</div>
